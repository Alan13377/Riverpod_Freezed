...
abstract class $CharacterCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String image, String gender});
}
...
class _$_Character implements _Character {
  ...
  @override
  String toString() {
    return 'Character(id: $id, name: $name, image: $image, gender: $gender)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, image, gender);
